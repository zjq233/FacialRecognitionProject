# -*- coding: utf-8 -*-
"""
Created on Wed Apr  3 10:42:31 2019
...
if __name__ == "__main__":
    eye=[[60,92],[128,66]]
    image =  Image.open("User.4.25.jpg")
    CropFace(image, eye[0], eye[1], offset_pct=(0.25,0.25), dest_sz=(180,180)).save("arnie.jpg")
'''
...
for imagePath in imagePaths:
    ...
    if len(eyes)==2:
        ...
        CropFace(PIL_img, eye[0], eye[1], offset_pct=(0.2,0.2), dest_sz=(200,200)).save('new'+imagePath[8:])
        count +=1
        print(imagePath)
print (count)        
